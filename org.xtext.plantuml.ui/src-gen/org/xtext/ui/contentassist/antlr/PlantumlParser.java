		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGroupingMessagesAccess().getAlternatives_1(), "rule__GroupingMessages__Alternatives_1");
					put(grammarAccess.getNoteAccess().getAlternatives_2(), "rule__Note__Alternatives_2");
					put(grammarAccess.getNoteAccess().getAlternatives_4(), "rule__Note__Alternatives_4");
					...
					put(grammarAccess.getNoteAccess().getGroup_2_0(), "rule__Note__Group_2_0__0");
					put(grammarAccess.getNoteAccess().getGroup_2_0_1(), "rule__Note__Group_2_0_1__0");
					put(grammarAccess.getNoteAccess().getGroup_2_0_1_2(), "rule__Note__Group_2_0_1_2__0");
					put(grammarAccess.getNoteAccess().getGroup_2_1(), "rule__Note__Group_2_1__0");
					put(grammarAccess.getNoteAccess().getGroup_2_1_1(), "rule__Note__Group_2_1_1__0");
					put(grammarAccess.getNoteAccess().getGroup_2_1_1_2(), "rule__Note__Group_2_1_1_2__0");
					put(grammarAccess.getNoteAccess().getGroup_2_2(), "rule__Note__Group_2_2__0");
					put(grammarAccess.getNoteAccess().getGroup_2_2_2(), "rule__Note__Group_2_2_2__0");
					put(grammarAccess.getNoteAccess().getGroup_4_0(), "rule__Note__Group_4_0__0");
					put(grammarAccess.getNoteAccess().getGroup_4_1(), "rule__Note__Group_4_1__0");
					put(grammarAccess.getNoteAccess().getGroup_4_1_0(), "rule__Note__Group_4_1_0__0");
					...
					put(grammarAccess.getAltElseAccess().getInstructionsAssignment_4(), "rule__AltElse__InstructionsAssignment_4");
					put(grammarAccess.getAltElseAccess().getElsesAssignment_5(), "rule__AltElse__ElsesAssignment_5");
					put(grammarAccess.getElseAccess().getInstructionsAssignment_4(), "rule__Else__InstructionsAssignment_4");
					put(grammarAccess.getGroupingMessagesAccess().getInstructionsAssignment_4(), "rule__GroupingMessages__InstructionsAssignment_4");
					put(grammarAccess.getNoteAccess().getRidAssignment_2_0_1_1(), "rule__Note__RidAssignment_2_0_1_1");
					put(grammarAccess.getNoteAccess().getRidsAssignment_2_0_1_2_1(), "rule__Note__RidsAssignment_2_0_1_2_1");
					put(grammarAccess.getNoteAccess().getLidAssignment_2_1_1_1(), "rule__Note__LidAssignment_2_1_1_1");
					put(grammarAccess.getNoteAccess().getLidsAssignment_2_1_1_2_1(), "rule__Note__LidsAssignment_2_1_1_2_1");
					put(grammarAccess.getNoteAccess().getOidAssignment_2_2_1(), "rule__Note__OidAssignment_2_2_1");
					put(grammarAccess.getNoteAccess().getOidsAssignment_2_2_2_1(), "rule__Note__OidsAssignment_2_2_2_1");
					...
					put(grammarAccess.getBoxAccess().getDefinitionsAssignment_7_0(), "rule__Box__DefinitionsAssignment_7_0");
				}
			};
		}
