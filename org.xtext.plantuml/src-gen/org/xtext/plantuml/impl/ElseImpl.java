 ...
 * <ul>
 *   <li>{@link org.xtext.plantuml.impl.ElseImpl#getInstructions <em>Instructions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ElseImpl extends MinimalEObjectImpl.Container implements Else
{
  ...
  {
    return PlantumlPackage.Literals.ELSE;
  }
  ...
  public EList<Instruction> getInstructions()
  {
    ...
    {
      instructions = new EObjectContainmentEList<Instruction>(Instruction.class, this, PlantumlPackage.ELSE__INSTRUCTIONS);
    }
    return instructions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PlantumlPackage.ELSE__INSTRUCTIONS:
